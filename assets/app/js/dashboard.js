...
/*
 * 
 * This file detects the current url path, and higlights the selected link. Taken from saasbox dashboard.
 *
...
/*
// The way it works in SaaSBox Dashboard:
...
let link = $("#sidebar-nav").find(`a[href*="${paths}"]`);
link.removeClass("text-gray-500 hover_bg-indigo-50");
link.addClass("text-white bg-indigo-500");